...
Кажется, что можно не выравнивать строки, а писать размер строки в фиксированном блоке в начале строки. Но нужно подумать, с какими трейдоффами придется столкнуться
